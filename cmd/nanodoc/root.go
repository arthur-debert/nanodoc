...
var rootCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if saveToBundlePath != "" {
			if err := saveBundleFile(saveToBundlePath, args, opts); err != nil {
				return err
			}
...
func saveBundleFile(path string, args []string, opts nanodoc.FormattingOptions) error {
	...
	content.WriteString("# Command: nanodoc " + strings.Join(os.Args[1:], " ") + "\n\n")
