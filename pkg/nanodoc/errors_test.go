...
func TestRangeError(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantMsg:  "invalid range 'L10-5': end line before start line (see: nanodoc topics content)",
		...
		},
		{
			...
			wantMsg:  "invalid range 'L-5': negative line number (see: nanodoc topics content)",
